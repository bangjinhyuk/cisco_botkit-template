  ...
  function Meeting(attrs, options) {
    ...
    _this.getMediaStreams = function (mediaDirection) {
      ...
      if (mediaDirection && (mediaDirection.sendAudio || mediaDirection.sendVideo || mediaDirection.sendShare)) {
        ...
        var _ref2 = audioVideo && audioVideo.video || { deviceId: null },
        ...
        if (preferredVideoDevice) {
          ...
          audioVideo = (0, _extends3.default)({}, audioVideo, {
            video: (0, _extends3.default)({}, audioVideo.video, {
    ...
    _this.getSupportedDevices = function (_ref3) {
      var _ref3$sendAudio = _ref3.sendAudio,
          sendAudio = _ref3$sendAudio === undefined ? true : _ref3$sendAudio,
          _ref3$sendVideo = _ref3.sendVideo,
          sendVideo = _ref3$sendVideo === undefined ? true : _ref3$sendVideo;
    ...
    */
     ...
     * @memberof Meeting
     */
    _this.locusInfo = new _locusInfo2.default(_this.updateMeetingObject.bind(_this), _this.webex, _this.id);
  ...
  (0, _createClass3.default)(Meeting, [{
    ...
    value: function setupLocusControlsListener() {
      ...
      this.locusInfo.on(_constants.LOCUSINFO.EVENTS.CONTROLS_RECORDING_UPDATED, function (_ref4) {
        ...
        _triggerProxy2.default.trigger(_this8, {
          file: 'meeting/index',
    ...
    value: function setUpLocusMediaSharesListener() {
      ...
      this.locusInfo.on(_constants.EVENTS.LOCUS_INFO_UPDATE_MEDIA_SHARES, function (payload) {
        ...
        if (_this9.isSharing && _this9.selfId !== contentId && disposition !== _constants.FLOOR_ACTION.RELEASED) {
          _this9.updateShare({
            sendShare: false,
            receiveShare: _this9.mediaProperties.mediaDirection.receiveShare
          }).finally(function () {
            _this9.isSharing = false;
        ...
        // Check if remote started a share
          ...
          else if (_this9.selfId !== contentId && disposition === _constants.FLOOR_ACTION.RELEASED) {
              _triggerProxy2.default.trigger(_this9, {
                file: 'meetings/index',
                function: 'remoteShare'
    ...
    value: function setUpLocusInfoMeetingListener() {
      ...
      this.locusInfo.on(_constants.EVENTS.DESTROY_MEETING, function (payload) {
        ...
        if (payload.shouldLeave) {
          ...
          _this13.leave({ reason: payload.reason }).then(function () {
            ...
            _loggerProxy2.default.logger.error('Meeting:index#setUpLocusInfoMeetingListener --> DESTROY_MEETING. Issue with leave for meeting, meeting still in collection: ' + _this13.meeting + ', error: ' + error);
          });
        } else {
          _loggerProxy2.default.logger.info('Meeting:index#setUpLocusInfoMeetingListener --> MEETING_REMOVED_REASON', payload.reason);
          _util2.default.cleanUp(_this13);
          _triggerProxy2.default.trigger(_this13, {
            file: 'meeting/index',
    ...
    value: function unsetRemoteStream() {
      _loggerProxy2.default.logger.warn('Meeting:index#unsetRemoteStream --> [DEPRECATION WARNING]: unsetRemoteStream has been deprecated after v1.89.3');
    ...
    value: function closeRemoteStream() {
      _loggerProxy2.default.logger.warn('Meeting:index#closeRemoteStream --> [DEPRECATION WARNING]: closeRemoteStream has been deprecated after v1.89.3');
    ...
    value: function closeRemoteTracks() {
      ...
      var _mediaProperties = this.mediaProperties,
          remoteAudioTrack = _mediaProperties.remoteAudioTrack,
          remoteVideoTrack = _mediaProperties.remoteVideoTrack,
          remoteShare = _mediaProperties.remoteShare;
      ...
      var stopTrack = function stopTrack(track, type) {
        return _media2.default.stopTracks(track).then(function () {
          ...
          if (isTrackStopped) {
            ...
            _loggerProxy2.default.logger.warn('Meeting:index#closeRemoteTracks --> Error: MediaStreamTrack.readyState is ' + track.readyState + ' for ' + type);
          }
        });
      };

      return _promise2.default.all([stopTrack(remoteAudioTrack, _constants.EVENT_TYPES.REMOTE_AUDIO), stopTrack(remoteVideoTrack, _constants.EVENT_TYPES.REMOTE_VIDEO), stopTrack(remoteShare, _constants.EVENT_TYPES.REMOTE_SHARE)]);
    }
    ...
    value: function closeLocalStream() {
      ...
      var _mediaProperties2 = this.mediaProperties,
          audioTrack = _mediaProperties2.audioTrack,
          videoTrack = _mediaProperties2.videoTrack;


      return _media2.default.stopTracks(audioTrack).then(function () {
        return _media2.default.stopTracks(videoTrack);
      }).then(function () {
        ...
        if (audioStopped && videoStopped) {
          ...
          _loggerProxy2.default.logger.warn('Meeting:index#closeLocalStream --> Error: MediaStreamTrack.readyState is incorrect.');
        }
      });
    }
    ...
    value: function closeLocalShare() {
      ...
      return _media2.default.stopTracks(track).then(function () {
        if (track && track.readyState === _constants.ENDED) {
          ...
          _loggerProxy2.default.logger.warn('Meeting:index#closeLocalShare --> Error: MediaStreamTrack.readyState is ' + track.readyState + ' for localShare');
        }
      });
    }
    ...
    value: function muteAudio() {
      ...
      .then(function () {
        return _this22.mute(_this22.members.selfId, true);
      }).then(function () {
        _metrics2.default.postEvent({
    ...
    value: function joinWithMedia() {
      ...
      return this.join(joinOptions).then(function (joinResponse) {
        return _this26.getMediaStreams(mediaSettings, audioVideoOptions).then(function (_ref5) {
    ...
    value: function moveFrom(resourceId) {
      ...
      return _util2.default.joinMeetingOptions(this).then(function (join) {
        return _this30.getMediaStreams({ sendAudio: true, sendVideo: true, sendShare: false }).then(function (_ref7) {
    ...
    value: function changeVideoLayout(layoutType) {
      ...
      var _mediaProperties3 = this.mediaProperties,
          mediaDirection = _mediaProperties3.mediaDirection,
          remoteVideoTrack = _mediaProperties3.remoteVideoTrack;
