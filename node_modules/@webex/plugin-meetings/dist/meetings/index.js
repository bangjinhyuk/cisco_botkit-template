  ...
  (0, _createClass3.default)(Meetings, [{
    ...
    value: function handleLocusEvent(data) {
      ...
      if (data.locus && data.locus.replaces && data.locus.replaces.length > 0) {
        ...
        meeting = data.locus.replaces.some(function (replacedLocus) {
          return _this2.meetingCollection.getByKey(_constants.LOCUS_URL, replacedLocus.locusUrl);
        });
      }
    ...
    value: function create(destination) {
      ...
      .catch(function (error) {
        ...
        if (type === _constants._CONVERSATION_URL_ || options.type === _constants._CONVERSATION_URL_) {
          meeting = _this8.meetingCollection.getByKey(_constants.CONVERSATION_URL, targetDest);
        }

        // Attempt to collect the meeting if it exists.
        if (!meeting) {
          meeting = _this8.meetingCollection.getByKey(_constants.SIP_URI, targetDest);
        }
