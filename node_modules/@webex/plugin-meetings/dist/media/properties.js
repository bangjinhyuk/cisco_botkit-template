...
var MediaProperties = function () {
  ...
  function MediaProperties() {
    ...
    Object.defineProperty(this, 'remoteStream', {
      ...
      get: function get() {
        _loggerProxy2.default.logger.warn('Media:properties#remoteStream --> [DEPRECATION WARNING]: remoteStream (getter) has been deprecated after v1.89.3 (use remoteAudioTrack, remoteVideoTrack instead)');

        // return if set or create a stream for backwards compatibility
        return _util2.default.createMediaStream([_this.remoteAudioTrack, _this.remoteVideoTrack]);
      }
    });
  }
  ...
  (0, _createClass3.default)(MediaProperties, [{
    ...
    value: function setRemoteStream(remoteStream) {
      _loggerProxy2.default.logger.warn('Media:properties#setRemoteStream --> [DEPRECATION WARNING]: setRemoteStream has been deprecated after v1.89.3 (use setRemoteAudioTrack, setRemoteVideoTrack instead)');
      // calls setter
    ...
    value: function unsetRemoteStream() {
      _loggerProxy2.default.logger.warn('Media:properties#unsetRemoteStream --> [DEPRECATION WARNING]: unsetRemoteStream has been deprecated after v1.89.3 (use unsetRemoteTracks instead)');
    ...
    value: function unsetRemoteStreams() {
      _loggerProxy2.default.logger.warn('Media:properties#unsetRemoteStreams --> [DEPRECATION WARNING]: unsetRemoteStreams has been deprecated after v1.89.3 (use unsetRemoteTracks instead)');
    ...
    value: function unsetMediaStreams() {
      _loggerProxy2.default.logger.warn('Media:properties#unsetMediaStreams --> [DEPRECATION WARNING]: unsetMediaStreams has been deprecated after v1.89.3 (use unsetMediaTracks instead)');
      this.unsetLocalVideoTrack();
      this.unsetRemoteStream();
    }
