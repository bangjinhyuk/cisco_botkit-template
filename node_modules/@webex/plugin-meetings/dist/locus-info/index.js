  ...
  (0, _createClass3.default)(LocusInfo, [{
    ...
    value: function updateControls(controls) {
      if (controls && !(0, _isEqual3.default)(this.controls, controls)) {
        ...
        var _ControlsUtils$getCon = _controlsUtils2.default.getControls(this.controls, controls),
            updates = _ControlsUtils$getCon.updates,
        ...
        if (updates.hasRecordingChanged || updates.hasRecordingPausedChanged) {
          ...
          if (updates.hasRecordingChanged) {
            ...
            state = current.record.paused ? _constants.RECORDING_STATE.PAUSED : _constants.RECORDING_STATE.RESUMED;
          }
    ...
    value: function updateConversationUrl(conversationUrl, info) {
      if (conversationUrl && !(0, _isEqual3.default)(this.conversationUrl, conversationUrl)) {
        ...
        this.updateMeeting({ conversationUrl: conversationUrl });
