...
var _isomorphicWebcrypto = require('isomorphic-webcrypto');

var _isomorphicWebcrypto2 = _interopRequireDefault(_isomorphicWebcrypto);
...
(0, _pkijs.setEngine)('newEngine', _isomorphicWebcrypto2.default, new _pkijs.CryptoEngine({
  name: '',
  crypto: _isomorphicWebcrypto2.default,
  subtle: _isomorphicWebcrypto2.default.subtle
}));
