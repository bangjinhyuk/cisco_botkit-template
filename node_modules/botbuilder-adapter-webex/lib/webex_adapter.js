...
class WebexAdapter extends botbuilder_1.BotAdapter {
    ...
    constructor(config) {
         ...
         * @ignore
         */
        this.botkit_worker = botworker_1.WebexBotWorker;
    ...
    resetWebhookSubscriptions() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                this._api.webhooks.list().then((list) => __awaiter(this, void 0, void 0, function* () {
                    for (let i = 0; i < list.items.length; i++) {
                        yield this._api.webhooks.remove(list.items[i]).catch(reject);
                    }
                    resolve();
                }));
            });
     ...
     * @param webhook_path the path of the webhook endpoint like `/api/messages`
     */
    registerAdaptiveCardWebhookSubscription(webhook_path) {
    ...
    deleteActivity(context, reference) {
        return __awaiter(this, void 0, void 0, function* () {
            if (reference.activityId) {
                try {
                    yield this._api.messages.remove({ id: reference.activityId });
                }
                catch (err) {
                    throw new Error(err);
                }
    ...
    processActivity(req, res, logic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (payload.resource === 'messages' && payload.event === 'created') {
                ...
                const decrypted_message = yield this._api.attachmentActions.get(payload.data);
                activity = {
                    id: decrypted_message.id,
                    timestamp: new Date(),
                    channelId: 'webex',
                ...
                activity = {
                    ...
                    recipient: { id: this.identity.id },
                    channelData: Object.assign(Object.assign({}, payload), { botkitEventType: payload.resource + '.' + payload.event }),
                    type: botbuilder_1.ActivityTypes.Event
                };
                const context = new botbuilder_1.TurnContext(this, activity);
                this.runMiddleware(context, logic)
